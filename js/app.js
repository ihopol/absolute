(() => {
  ...
  function a(e = {}, t = {}) {
    Object.keys(t).forEach((s) => {
      void 0 === e[s]
        ? (e[s] = t[s])
        : r(t[s]) && r(e[s]) && Object.keys(t[s]).length > 0 && a(e[s], t[s]);
    });
  }
  const o = {
    body: {},
  ...
  const G = {
    loopCreate: function () {
      ...
      for (let e = 0; e < o.length; e += 1)
        n.append(w(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      for (let e = a.length - 1; e >= 0; e -= 1)
        n.prepend(w(a[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
    },
    loopFix: function () {
      const e = this;
    ...
    oe(),
      document.querySelector(".carousel__slider") &&
        new se(".carousel__slider", {
          ...
          thumbs: {
            swiper: { el: ".carouselThumb__slider", slidesPerView: 4 },
          },
          on: {},
        });
  });
  document
    .querySelector(".header__button--blue")
    .addEventListener("click", function () {
      document
        .querySelector(".header__form")
        .classList.toggle("header__form--show");
    });
  const le = document.querySelector(".header__menu"),
    de = le.offsetTop;
  (window.onscroll = function () {
    window.pageYOffset > de
      ? le.classList.add("header__menu--sticky")
      : le.classList.remove("header__menu--sticky");
  }),
    (window.FLS = !0),
    (function (e) {
      let t = new Image();
